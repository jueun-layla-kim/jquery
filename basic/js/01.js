$(function(){
    ...
    $('.text_1').prevUntil('.title_1').css('border', '2px solid green') // 범위
    $('.text_1').nextUntil('.text_5').css('backgroundColor', '#666') // 범위

    $('.section h3').siblings().css('color', 'red') // 형제

    $('.sub_item_1').parents().css('border', '3px dotted green') // 상위
